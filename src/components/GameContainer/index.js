...
class GameContainer extends Component {
    ...
    handleItemClick = (item) => {
        ...
        this.setState({ clickers: this.shuffleClickers(newClickers), score: this.state.score, highScore: this.scoreCheck() });
    ...
    resetGame = () => {
        ...
        this.setState({ clickers: this.shuffleClickers(unclicked), score: this.state.score });
    }
